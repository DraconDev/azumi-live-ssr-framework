...
While designed to work seamlessly with `DraconDev/azumi-interactive-html`, it can be used independently with any backend that follows the Azumi protocol.
...
If you are using `azumi.js` without `DraconDev/azumi-interactive-html`, your server must implement the following:
