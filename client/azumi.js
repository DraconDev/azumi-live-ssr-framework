...
class Azumi {
     ...
     * Supports: field lookup, 'literal', "literal", 123, true/false/null
     * Note: ternary (? :), compound logic (||), and arithmetic (+ N, - N) are
     * intentionally removed. Compute derived values in Rust, not HTML attributes.
     */
